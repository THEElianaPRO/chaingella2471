...
PM_START_TEXT = """
ʜᴇʟʟᴏ, ɪᴍ Layla ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
yone_IMG = "https://telegra.ph/file/aaa10262ebe6670eecf58.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @HEROGAMERS1 \
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(yone_about_callback, pattern=r"layla_")
