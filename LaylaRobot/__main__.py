    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" 🌎 Your own DeFi universe in one app\n✨ Powered by cross chain magic.\n\n
                 ...
                 🔥 You can download our app from the [Appstore](https://apps.apple.com/ro/app/chainge-finance/id1578987516) (iOS) 🔥 [Google Play](https://play.google.com/store/apps/details?id=com.fusion.chainge.android) Android\n
