...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import LaylaRobot.events

        path = Path(f"LaylaRobot/modules/{shortname}.py")
        name = "LaylaRobot.modules.{}".format(shortname)
        ...
        mod.LaylaRobot = LaylaRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["LaylaRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "LaylaRobot/modules/*.py"
