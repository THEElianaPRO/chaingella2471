...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = ".LaylaRobot/resources/fonts/"
    ...
    if not bg_:
        ...
        bg_ = await id_.download_media()
    if not font_:
        fpath_ = glob.glob("LaylaRobot/resources/fonts/*")
    ...
    if os.path.exists(font_):
        if not font_.startswith("LaylaRobot/resources/fonts"):
            os.remove(font_)
